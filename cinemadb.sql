...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Dec 09. 10:29
...
-- Adatbázis: `cinemadb`
--
CREATE DATABASE IF NOT EXISTS `cinemadb` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `cinemadb`;
...
CREATE TABLE `film_type` (
  ...
  `type_name` varchar(100) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
ALTER TABLE `movies`
  ...
  ADD CONSTRAINT `movies_ibfk_3` FOREIGN KEY (`actor_id`) REFERENCES `actors` (`actor_id`) ON DELETE CASCADE;
COMMIT;
